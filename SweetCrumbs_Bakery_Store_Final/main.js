const products = [
  ...
  ["Hot Chocolate","Drinks",399,"https://images.unsplash.com/photo-1542990253-0d0f5be5f8d4?auto=format&fit=crop&w=800&q=80","Velvety chocolate drink with whipped cream."],
...
$("offerBtn").addEventListener("click", async () => {
  try {
    await navigator.clipboard.writeText("SWEET20");
    showToast("Offer code SWEET20 copied!");
  } catch {
    showToast("Offer code: SWEET20");
  }
});
